...
public class Billing {
    ...
    List<String> itemizedCharges; // List of services or items billed
    double totalAmount;
    double amountPaid;
    double amountDue;
    ...
    public Billing(Patient patient,HospitalStaff generatedBy, List<String> itemizedCharges, double amountPaid, String paymentMethod) {
        ...
        this.insurancePolicyNo = patient.insurancePolicyNo;
    }
    ...
    public void displayBillingDetails() {
        System.out.println("\nBilling Details for Patient: " + patient.name);
        ...
        if (paymentMethod.equalsIgnoreCase("Insurance")) {
