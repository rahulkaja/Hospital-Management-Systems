...
public class HospitalStaff {
    ...
    String department;
    String position;
    String staffType; // Nurse, Janitor, Receptionist, etc.
    String contactNo;
    double salary;
    String shiftTiming; // Morning, Evening, Night
    int yearsOfExperience;
    boolean isAvailable;
    Doctor supervisingDoctor; // Only applicable to nurses or similar staff

    // Constructor
    public HospitalStaff(String name, int age, String department, String position, String staffType, String joiningDate,
                         String contactNo, double salary, String shiftTiming) {
        this.name = name;
        this.age = age;
    ...
    public void displayDetails() {
        ...
        if (supervisingDoctor != null) {
            System.out.println("Supervising Doctor: " + supervisingDoctor.doctorName);
        }
    }
}
